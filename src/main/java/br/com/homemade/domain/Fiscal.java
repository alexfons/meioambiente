...
public class Fiscal implements Serializable {
    ...
    public Fiscal email(String email) {
        this.email = email;
        return this;
    }
    ...
    public Fiscal funcao(String funcao) {
        this.funcao = funcao;
        return this;
    }
    ...
    public Fiscal localtrabalho(String localtrabalho) {
    ...
    public Fiscal matricula(String matricula) {
    ...
    public Fiscal nome(String nome) {
        this.nome = nome;
        return this;
    }
    ...
    public Fiscal superintendencia(String superintendencia) {
    ...
    public Fiscal telefone(Long telefone) {
    ...
    public Fiscal telefonecomercial(Long telefonecomercial) {
