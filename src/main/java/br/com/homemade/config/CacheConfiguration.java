...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(br.com.homemade.domain.CertifConfor.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.homemade.domain.CertifConfor.class.getName() + ".informesCertifIrregs", jcacheConfiguration);
            cm.createCache(br.com.homemade.domain.CertifConfor.class.getName() + ".notificacaosCertifIrregs", jcacheConfiguration);
            cm.createCache(br.com.homemade.domain.CertifConfor.class.getName() + ".ocorrenciasCertifIrregs", jcacheConfiguration);
            ...
            cm.createCache(br.com.homemade.domain.InformeCertifIrreg.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(br.com.homemade.domain.NotificacaoCertifIrreg.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(br.com.homemade.domain.OcorrenciaCertifIrreg.class.getName(), jcacheConfiguration);
            ...
            cm.createCache(br.com.homemade.domain.TipocertifConfor.class.getName(), jcacheConfiguration);
