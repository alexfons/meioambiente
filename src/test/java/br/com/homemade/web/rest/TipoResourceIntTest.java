...
public class TipoResourceIntTest {
    ...
    public void setup() {
        ...
        TipoResource tipoResource = new TipoResource(tipoRepository, tipoMapper);
    ...
    public void createTipo() throws Exception {
        ...
        assertThat(testTipo.getCategoria()).isEqualTo(DEFAULT_CATEGORIA);
        assertThat(testTipo.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
        assertThat(testTipo.getSubcategoria()).isEqualTo(DEFAULT_SUBCATEGORIA);
    }
    ...
    public void updateTipo() throws Exception {
        ...
        Tipo testTipo = tipoList.get(tipoList.size() - 1);
        assertThat(testTipo.getCategoria()).isEqualTo(UPDATED_CATEGORIA);
        assertThat(testTipo.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
        assertThat(testTipo.getSubcategoria()).isEqualTo(UPDATED_SUBCATEGORIA);
    }
