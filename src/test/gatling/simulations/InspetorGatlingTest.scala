...
/**
 * Performance test for the Inspetor entity.
 */
class InspetorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Inspetor entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created inspetor")
                .get("${new_inspetor_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created inspetor")
            .delete("${new_inspetor_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
