...
/**
 * Performance test for the Administrativo entity.
 */
class AdministrativoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Administrativo entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all administrativos")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created administrativo")
                .get("${new_administrativo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created administrativo")
            .delete("${new_administrativo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
