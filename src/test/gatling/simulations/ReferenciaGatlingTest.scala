...
/**
 * Performance test for the Referencia entity.
 */
class ReferenciaGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Referencia entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created referencia")
                .get("${new_referencia_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created referencia")
            .delete("${new_referencia_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
